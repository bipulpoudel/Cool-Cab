            ...
            <div className="container">
                ...
                <div className="col-md-3 col-6">
                    ...
                    <div className="counter-icon">
                        <img src="./images/icon/counter-icon-1.png" alt="Bipul Poudel" />
                    </div>
                    <h2>
                ...
                <div className="col-md-3 col-6">
                    <div className="single-counter">
                    <div className="counter-icon">
                        <img src="./images/icon/counter-icon-2.png" alt="Bipul Poudel" />
                    </div>
                    <h2>
                ...
                <div className="col-md-3 col-6">
                    <div className="single-counter">
                    <div className="counter-icon">
                        <img src="./images/icon/counter-icon-3.png" alt="Bipul Poudel" />
                    </div>
                    <h2>
                ...
                <div className="col-md-3 col-6">
                    <div className="single-counter">
                    <div className="counter-icon">
                        <img src="./images/icon/counter-icon4.png" alt="Bipul Poudel" />
                    </div>
                    <h2>
