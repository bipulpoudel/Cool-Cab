                ...
                <div className='row'>
                    ...
                    <div className='col-lg-7'>
                        <div className='download-text'>
                            ...
                            <p>
                                Nunc volutpat tincidunt est a scelerisque.
                                Aliquam erat volutpat. Donec varius ex in justo
                                pharetra, nec mollis erat porta. Donec sit amet
                                facilisis neque. In hac habitasse platea
                                dictumst.
                            </p>
                        </div>
